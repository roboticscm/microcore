...
export class Authentication {
  ...
  static login = (accessToken, refreshToken, userId, username, partnerId) => {
    if (localStorage.getItem('remember') === 'true') {
  ...
  static setHeader = (token) => {
    // token = `${token}|||${LoginInfo.companyId$.value}|${LoginInfo.branchId$.value}|${LoginInfo.departmentId$.value}|${LoginInfo.getPartnerId()}`;
