var index = "";
var all_min = "";
String.prototype.insertAt = function(index2, string) {
  return this.substring(0, index2) + string + this.substring(index2);
};
...
String.prototype.isEmpty = function() {
  ...
  return this === null || this === void 0 || this.trim().length === 0;
};
